...
4. Тільки те, що є в матеріалі. НЕ вигадуй деталей, цифр, подій. Якщо фактів мало —
   ...
   watching порожніми ("") , а не додавай воду.
5. what_it_means — конкретний наслідок саме з цих фактів (для кого що зміниться), не
   переказ заголовка й не банальність. Якщо конкретного наслідку з фактів не випливає —
   залиш "".
6. watching — лише конкретне продовження, що випливає з фактів: наступний крок, дата,
   очікуване рішення, названа особа/сторона. НЕ пиши «дивіться відео/фото», «стежте за
   новинами» тощо. Якщо конкретного продовження нема — залиш "".
{feedback}
МАТЕРІАЛ:
{material}"""
